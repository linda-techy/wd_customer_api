...
public class ObservationService {
    ...
    public ObservationDto createObservation(Long projectId, ObservationRequest request, 
        ...
        if (image != null && !image.isEmpty()) {
            String imagePath = fileStorageService.storeFile(image, "projects/" + projectId + "/observations");
    ...
    public ObservationDto resolveObservation(Long observationId, ObservationResolveRequest request, Long userId) {
        ...
        observation.setStatus(Observation.ObservationStatus.RESOLVED);
    ...
    public List<ObservationDto> getObservations(Long projectId, String status) {
        ...
        if (status != null) {
            Observation.ObservationStatus obsStatus = Observation.ObservationStatus.valueOf(status);
            observations = observationRepository.findByProjectIdAndStatusOrderByPriorityDescReportedDateDesc(projectId, obsStatus);
        } else {
    ...
    private ObservationDto toDto(Observation obs) {
        return new ObservationDto(
            ...
            obs.getResolvedBy() != null ? obs.getResolvedBy().getFirstName() + " " + obs.getResolvedBy().getLastName() : null,
