...
public class ObservationService {
    ...
    public List<ObservationDto> getObservations(Long projectId, String status) {
        ...
        if (status != null) {
            ...
            observations = observationRepository.findByProjectIdAndStatusOrderByPriorityDescReportedDateDesc(projectId,
                    obsStatus);
        } else {
    ...
    public List<ObservationDto> getActiveObservations(Long projectId) {
        ...
        return observationRepository
                .findByProjectIdAndStatusInOrderByPriorityDescReportedDateDesc(projectId, activeStatuses)
                .stream()
                .map(this::toDto)
    ...
    private ObservationDto toDto(Observation obs) {
        return new ObservationDto(
                ...
                obs.getResolvedBy() != null
                        ? obs.getResolvedBy().getFirstName() + " " + obs.getResolvedBy().getLastName()
                        : null,
