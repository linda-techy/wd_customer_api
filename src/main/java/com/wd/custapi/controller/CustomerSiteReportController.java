    ...
    public ResponseEntity<ApiResponse<Page<CustomerSiteReportDto>>> getCustomerSiteReports(
        ...
        try {
            ...
            return ResponseEntity.status(500)
                    .body(new ApiResponse<>(false, "Failed to retrieve site reports: " + e.getMessage(), null));
        }
    }
        ...
        try {
            ...
            if (report == null) {
                return ResponseEntity.status(404)
                        .body(new ApiResponse<>(false, "Site report not found with id: " + id, null));
            }
            ...
            return ResponseEntity.status(500)
                    .body(new ApiResponse<>(false, "Failed to retrieve site report: " + e.getMessage(), null));
        }
    }
}
